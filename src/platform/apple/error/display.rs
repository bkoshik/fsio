...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::NotFound(arg) => write!(f, "No such file or directory: {}", arg),
            Self::NoSuchProcess(arg) => write!(f, "No such process: {}", arg),
            Self::Interrupted => write!(f, "Interrupted"),
            Self::IoError(arg) => write!(f, "I/O error: {}", arg),
            ...
            Self::FileTooLarge(arg) => write!(f, "File too large: {}", arg),
            ...
            Self::NetworkUnreachable(arg) => write!(f, "Network unreachable: {}", arg),
            ...
            Self::TimedOut(arg) => write!(f, "Connection timed out: {}", arg),
