...
pub enum Error {
    ...
    NotFound(String) = 2,                                   // libc::ENOENT,
    NoSuchProcess(u32) = 3,                                 // libc::ESRCH,
    Interrupted = 4,                                        // libc::EINTR,
    IoError(String) = 5,                                    // libc::EIO,
    ...
    FileTooLarge(u64) = 27,                                 // libc::EFBIG,
    ...
    NetworkUnreachable(String) = 51,                        // libc::ENETUNREACH,
    ...
    TimedOut(u64) = 60,                                     // libc::ETIMEDOUT,
